...
static const char *const autostart[] = {
	"killall",   "-9",          "xflux",                  "picom",                            "nm-applet", "clipit", NULL,
	"nm-applet", NULL,
	"clipit",    NULL,
	"st",        NULL,
	"xflux",     "-l",          "0",                      NULL,
	"picom",     "-b",          "--experimental-backend", NULL,
	"dwmblocks", ">",           "~/log/.dwmblocks.log",   NULL,
	"feh",       "--randomize", "--bg-fill",              "/home/shawn/Pictures/Wallpapers/", NULL,
	NULL,
};
...
static const Rule rules[] = {
	...
	RULE(.class = "neovide",         .tags = 3)
	RULE(.class = "Code",            .tags = 3)
	RULE(.class = "Code - Insiders", .tags = 3)
	RULE(.class = "riotclientux.exe",.tags = 3)
	RULE(.class = "Zenity",          .tags = 3)
	RULE(.class = "zenity",          .tags = 3)
	RULE(.class = "wine",            .tags = 3)
	RULE(.class = "wine.exe",        .tags = 3)
...
static Key keys[] = {
	...
	{ 0,                 /*0xe9*/ XF86XK_MonBrightnessUp  , spawn,          SHCMD("light -A 5 && dunstify 'Light:' -h int:value:$(light)" )},
	{ 0,                 /*0xe8*/ XF86XK_MonBrightnessDown, spawn,          SHCMD("light -U 5 && dunstify 'Light:' -h int:value:$(light)" )},
	{ 0,                 /*0x79*/ XF86XK_AudioMute,         spawn,          SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle&&dunstify 'Mute' -h int:value:$(pamixer --get-volume)" ) },
	{ 0,                 /*0x7a*/ XF86XK_AudioLowerVolume,  spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -10%&&dunstify 'Vol' -h int:value:$(pamixer --get-volume)" ) },
	{ 0,                 /*0x7b*/ XF86XK_AudioRaiseVolume,  spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +10%&&dunstify 'Vol' -h int:value:$(pamixer --get-volume)" ) },
	{ 0,                 /*0xac*/ XF86XK_AudioPlay,          spawn,          SHCMD("playerctl play-pause ; dunstify $($HOME/dotfiles/config/i3/media.sh)" )},
	{ 0,                 /*0xab*/ XF86XK_AudioNext,         spawn,          SHCMD("playerctl next       ; dunstify $($HOME/dotfiles/config/i3/media.sh)" )},
	{ 0,                 /*0xad*/ XF86XK_AudioPrev,         spawn,          SHCMD("playerctl previous   ; dunstify $($HOME/dotfiles/config/i3/media.sh)" )},

	{ ALT,               XK_F2,                               spawn,          {.v = dmenucmd } },
	{ MODKEY,            XK_Return,                           spawn,          {.v = termcmd } },
	{ MODKEY,            XK_b,                                spawn,          SHCMD("chrome") },
	{ MODKEY,            XK_d,                                spawn,          SHCMD("rofi -combi-modi window#drun -show combi -modi combi -show-icons")},
	{ MODKEY|SHIFT,      XK_Escape,                           spawn,          SHCMD("conky") },
	{ MODKEY,            XK_Print,                            spawn,          SHCMD("flameshot full -p $HOME/Pictures/Screenshots") },
	{ MODKEY|SHIFT,      XK_Print,                            spawn,          SHCMD("flameshot gui  -p $HOME/Pictures/Screenshots") },
	...
	// { CTRL|MODKEY,            XK_j,          // resize 
	// { CTRL|MODKEY,            XK_k,          // resize 
	{ CTRL|MODKEY,       XK_h,                                setmfact,       {.f = -0.05} },
	{ CTRL|MODKEY,       XK_l,                                setmfact,       {.f = +0.05} },
